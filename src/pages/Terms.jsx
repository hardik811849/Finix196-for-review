  ...
  return (
    <Box display={"flex"} justifyContent={"center"} mt={10}>
      ...
      >
        ...
        <Text mt={6}>
          The website located at https://www.finix.com (the “Site”) belongs to
          Finix196 Capital Inc., a Delaware corporation, together with its
          affiliates (“Company”, “us”, “our”, and “we”). Certain features of the
        ...
        <p style={{ marginTop: "1rem" }}>
          <strong> 1.2 Account Verification.</strong> To finish creating your
          account with us, you shall provide us with the information we request.
          We collect, verify and retain information for the purposes of identity
          verification and the detection of money laundering, terrorist
          financing, fraud, or any other financial crime. Such information may
          include your name, address, telephone number, email address, date of
          birth, banking information, and a picture of yourself holding your
          government-issued identification card. We may also request information
          regarding the source of your funds, income/employment information, and
          any additional information required for to comply with Applicable Laws
          and Regulations. When you provide information to us, you verify that
          the information provided is accurate and complete, and you agree to
          notify us in writing of any changes made to the information you
          provide. You hereby authorize us, directly or through a third party,
          to make any inquiries we consider necessary to verify your identity
          and/or protect against fraud, including but not limited to: (a) query
          identity information contained in public reports (e.g., your name,
          address, past addresses, or date of birth); and (b) take action we
          reasonably deem necessary based on the results of such inquiries and
          reports. You further authorize any and all third parties to which such
          inquiries or requests may be directed to fully respond to such
          inquiries or requests. We will have no liability or responsibility for
          any permanent or temporary inability to access or use any Services as
          a result of any identity verification or other screening procedures.
        </p>
        <p style={{ marginTop: "1rem" }}>
        ...
        <br />
        <h3 style={{ marginTop: "1rem" }}>
          <strong> 11. Acknowledgement of Digital Asset risks</strong>{" "}
        </h3>
        <p style={{ marginTop: "1rem" }}>
        ...
        <p style={{ marginTop: "1rem" }}>
          <strong> 11.5 Regulatory Framework.</strong> The regulatory status of
          tokens, digital assets and blockchain technology is unclear or
          unsettled in many jurisdictions. It is difficult to predict how or
          whether governmental authorities may regulate such technologies. It is
          likewise difficult to predict how or whether any governmental
          authority may make changes to existing laws, regulations or rules that
          may affect tokens, digital assts, and blockchain technology and its
          applications. Such changes could negatively impact digital assets in
          various ways, including, for example, through a determination that
          digital assets are a regulated financial instrument that requires
          registration.
        </p>
        <p style={{ marginTop: "1rem" }}>
        ...
        <p style={{ marginTop: "1rem" }}>
          ...
          trained and understand the risks of purchasing tokens using the Site.
          You are familiar with the risks involved with real estate
          tokenization. You can afford to take such risks. All amounts paid to
        ...
        <p>
          These Terms are subject to occasional revision, and if we makeany
        ...
        <p style={{ marginTop: "1rem" }}>
          ...
          Notice to the Company should be sent to: 2150 Town Square Pl, Suite
          200, Sugar Land, Texas 77479. After the Notice is received, you and
